...
def fuse_conv_and_bn(conv, bn):
    ...
    # conv.weight.shape [32,12,3,3]
    w_conv = conv.weight.clone().view(conv.out_channels, -1)   #[32.108]
    w_bn = torch.diag(bn.weight.div(torch.sqrt(bn.eps + bn.running_var))) #[32,32]
